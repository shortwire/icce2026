      ...
      <main className="container-boxed pt-4 pb-12 px-6">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
           ...
           <div className="lg:w-[70%] space-y-4">
              <div className="overflow-x-auto rounded-[10px] border border-black shadow-sm">
                <table className="w-full text-left border-collapse bg-white table-fixed min-w-[700px]">
                  <thead>
                    <tr className="border-b border-black">
                      <th rowSpan="2" className="px-4 py-3 uppercase text-[11px] font-black text-[#191961] text-center border-r border-black w-1/3">
                        INDIAN DELEGATES
                      </th>
                      <th colSpan="2" className="px-2 py-2 text-[11px] font-black text-[#191961] text-center border-r border-black">
                    ...
                    <tr className="border-b border-black">
                      <th className="px-2 py-2 text-[10px] font-black text-[#191961] text-center border-r border-black">IEEE Member</th>
                      <th className="px-2 py-2 text-[10px] font-black text-[#191961] text-center border-r border-black">Non-IEEE Member</th>
                      <th className="px-2 py-2 text-[10px] font-black text-[#191961] text-center border-r border-black">IEEE Member</th>
                      <th className="px-2 py-2 text-[10px] font-black text-[#191961] text-center">Non-IEEE Member</th>
                    </tr>
                  </thead>
                  <tbody>
                    {indianFees.map((fee, i) => (
                      <tr key={i} className="border-b border-black last:border-b-0">
                        <td className="px-4 py-2 text-[11px] font-bold text-gray-800 border-r border-black">{fee.category}</td>
                        <td className="px-2 py-2 text-center text-xs font-medium text-gray-800 border-r border-black">₹ {fee.earlyIEEE}</td>
                        <td className="px-2 py-2 text-center text-xs font-medium text-gray-800 border-r border-black">₹ {fee.earlyNonIEEE}</td>
                        <td className="px-2 py-2 text-center text-xs font-medium text-gray-800 border-r border-black">₹ {fee.lateIEEE}</td>
                        <td className="px-2 py-2 text-center text-xs font-medium text-gray-800">₹ {fee.lateNonIEEE}</td>
                      </tr>
                    ))}
                    <tr className="border-y border-black">
                      <th rowSpan="2" className="px-4 py-3 uppercase text-[11px] font-black text-[#191961] text-center border-r border-black bg-slate-50/50">
                        FOREIGN DELEGATES
                      </th>
                      <th colSpan="2" className="px-2 py-2 text-[11px] font-black text-[#191961] text-center border-r border-black bg-slate-50/50">
                        On/before September 15, 2026
                      </th>
                      <th colSpan="2" className="px-2 py-2 text-[11px] font-black text-[#191961] text-center bg-slate-50/50">
                        After September 15, 2026
                      </th>
                    </tr>
                    <tr className="border-b border-black">
                      <th className="px-2 py-2 text-[10px] font-black text-[#191961] text-center border-r border-black bg-slate-50/50">IEEE Member</th>
                      <th className="px-2 py-2 text-[10px] font-black text-[#191961] text-center border-r border-black bg-slate-50/50">Non-IEEE Member</th>
                      <th className="px-2 py-2 text-[10px] font-black text-[#191961] text-center border-r border-black bg-slate-50/50">IEEE Member</th>
                      <th className="px-2 py-2 text-[10px] font-black text-[#191961] text-center bg-slate-50/50">Non-IEEE Member</th>
                    </tr>
              ...
              <section className="p-6 border border-slate-100 rounded-3xl bg-slate-50/30">
                 ...
                 <div className="space-y-4">
                    ...
                    <div className="bg-white p-4 rounded-2xl border border-slate-100 text-center">
                       <p className="text-xs font-bold text-slate-600 mb-3 italic">The online registration portal will be active from September 1, 2026.</p>
        ...
        <section className="mt-12 pt-8 border-t border-slate-100 text-center">
           ...
           <p className="max-w-3xl mx-auto text-lg md:text-xl font-black italic text-[#191961] leading-relaxed tracking-tight px-4">
              "Join us at ICCE 2026 and be part of the global movement towards convergence in engineering. Register early to secure your spot at discounted rates."
           </p>
        </section>
